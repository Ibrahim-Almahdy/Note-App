...
This project is a fully functional Single Page Application (SPA) built using Vanilla JavaScript. It allows users to create, read, update, and delete notes (CRUD operations). The application utilizes the browser's LocalStorage API to ensure data persistence, meaning users will not lose their data upon refreshing or closing the page.
